...
public class TestOnAWSLambdaInvoker {
	...
	private AWSLambdaTestsData generateDataSendToLambda(String jarS3Location, String s3LocationToStoreOutput, String testToRun, String testServerURL){
		AWSLambdaTestsData testDataSendToLambda = new AWSLambdaTestsData().withJarS3Location(jarS3Location)
				.withS3LocationToStoreOutput(s3LocationToStoreOutput).withTestToRun(testToRun).withTestServerURL(testServerURL);
